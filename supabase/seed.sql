...
insert into public.ai_profiles (id, slug, name, tagline, description, strategy_type, strategy_version, accent_color, prefers, active) values
  ('ai-oracle', 'oracle', 'ATLAS', 'Weighs trend, momentum and volume', 'Patient and systematic. ATLAS only commits when the multi-day trend, short-term momentum and volume agree, and sits Neutral when they don''t.', 'rule-based-synthesis', 'atlas-v1.0.0', '#B45309', array['market-trend','momentum','volume'], true),
  ('ai-vector', 'vector', 'PULSE', 'Rides short-term momentum', 'Quick and decisive. PULSE follows the last one to three days of price action and is rarely Neutral.', 'rule-based-momentum', 'pulse-v1.0.0', '#92400E', array['momentum','market-trend','volatility'], true),
