...
// setting window.WANDERMERE_SERVER before this module loads.
// ============================================================

export const SERVER = (typeof window !== 'undefined' && window.WANDERMERE_SERVER != null)
  ? window.WANDERMERE_SERVER
  : '';
