...
export const DEMO_USERS: UserSpec[] = [
  {
    ...
    role: "user",
    bio: "Temporary guest account. Submissions made here are stored temporarily and may be reset.",
  ...
  },
  {
    ...
    role: "moderator",
    bio: "Moderator account for the review workflow.",
  ...
  },
  {
    ...
    role: "admin",
    bio: "Admin account for the integrations panel.",
    watchlistPublic: false,
    badges: ["moderator"],
    createdDaysAgo: 420,
    watchlist: [],
