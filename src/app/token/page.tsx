      ...
      <div className="mx-auto max-w-3xl space-y-8 px-4 py-10 sm:px-6">
        <div className="card border-neutral/40 p-5 text-sm" role="note">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5 text-muted">
            <li><strong className="text-text">No token is needed for the core forecasting experience.</strong> Rounds, scoring, leaderboards and Call Cards are and will remain free to use.</li>
            <li><strong className="text-text">The token is never used as a call stake.</strong> Forecasts always use virtual XP only.</li>
