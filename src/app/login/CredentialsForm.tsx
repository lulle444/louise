...
export function CredentialsForm({ mode, next }: { mode: "login" | "signup"; next: string }) {
  ...
  return (
    <form action={action} className="space-y-4">
      ...
      <button type="submit" disabled={pending} className="w-full rounded-full bg-cyan px-4 py-2.5 text-sm font-semibold text-white hover:brightness-110 disabled:opacity-60">
