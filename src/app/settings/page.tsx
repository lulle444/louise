...
export default async function SettingsPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Settings" title="Edit your public profile" description="Your username and scoring fields are managed by Alphr and cannot be edited here." />
