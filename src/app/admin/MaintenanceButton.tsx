...
export function MaintenanceButton() {
  ...
  return (
    <form action={run} className="flex flex-col items-end gap-2">
      <button type="submit" disabled={pending} className="inline-flex items-center gap-2 rounded-md bg-cyan px-4 py-2 text-sm font-semibold text-white hover:brightness-110 disabled:opacity-60">
