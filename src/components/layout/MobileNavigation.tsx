...
export function MobileNavigation({ items, viewer, demo }: { items: Array<{ href: string; label: string }>; viewer: Viewer | null; demo: boolean }) {
  ...
  return (
    <div className="ml-auto md:hidden">
      ...
      {open ? (
        <div id={id} className="fixed inset-x-0 top-16 z-50 border-b border-border bg-bg/95 p-4 backdrop-blur-md">
